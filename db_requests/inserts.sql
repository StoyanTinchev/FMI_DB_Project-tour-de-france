...
INSERT INTO Teams (registration_number, name, country)
VALUES (1, 'Team Sky', 'UK'),
       (2, 'Movistar Team', 'Spain'),
       (3, 'Bora-Hansgrohe', 'Germany');

-- Insert data into the Cyclists table
INSERT INTO Cyclists (registration_number, name, birth_date, nationality, team_registration_number)
...
INSERT INTO Stages (number, date, start_point, end_point, length)
...
INSERT INTO Results (cyclist_registration_number, stage_number, stage_time, total_time, stage_ranking)
